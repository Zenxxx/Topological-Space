...
\begin{definition1}{Open Set}{tag}
A subset $O$ of a distance space $X$ is an open set if and only if $\varepsilon$-neighbourhood of $x$ is in $O$ for any arbitrary point $x \in O$.

Thus,
\forall x \in O, \exists \varepsilon > 0, U_{\varepsilon} \subset O
\end{definition1} 
\end{document}